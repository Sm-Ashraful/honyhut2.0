      ...
      <div className="grid md:grid-cols-2 gap-[20px] font-carmo   my-[3rem]">
        ...
        <div className="">
          ...
          <p className="text-lg leading-8">
            ...
            behind a better approach to sex. It’s who we are:
            pleasure-heighteners, sex drive-accelerators, and orgasm-igniters,
            with one core goal… to make your next climax the best one yet.
          </p>
        </div>
        <div className="">
          ...
          <p className="text-lg leading-8">
            ...
            is as authentic as the next, we’re big on peace of mind. No
            ineffective formulas. No scary side-effects. No counterfeits. No
            exceptions.
          </p>
        </div>
        <div className="">
          ...
          <p className="text-lg leading-8">
            ...
            confidence, and unlocking unforgettable experiences as we go.
            Putting the right formulas in your corner, we think of it as the
            ultimate toolkit, adding a splash of spice back into your intimate
            moments, one sexual enhancement at a time.
          </p>
        </div>
      </div>
      <div>
        ...
        <div className="grid md:grid-cols-2">
          <p className="leading-8">
            ...
            <span>
              ...
              enhancement brands we carry. In turn, you can take peace of mind
              while you send your libido and performance soaring.
            </span>
          </p>
