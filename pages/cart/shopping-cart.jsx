                    ...
                    {data.map((item) => (
                      ...
                      >
                        ...
                        <td className="py-5 px-2 text-center flex justify-center items-center m-2">
                          <div className="flex justify-center items-center border border-gray rounded-full py-2 w-40 ">
                            {item.quantity}
                            <span
                              className="mr-2 ml-12 font-bold cursor-pointer hover:text-primary-red bg-gray rounded-lg"
                              onClick={() => handleDecreaseQuantity(item)}
                            >
                              <AiOutlineMinus />
                            </span>
                            <span
                              className="ml-2 font-bold cursor-pointer hover:text-primary-red bg-gray rounded-full"
